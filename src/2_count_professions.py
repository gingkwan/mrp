...
def main():
    ...
    file_summary = pd.read_csv("../output/file_summary.csv")
    ...
    plt.savefig('../output/top_professions.png', bbox_inches='tight', transparent=False, facecolor='white')
    plt.show()

    # Save profession counts to CSV
    profession_df.to_csv('../output/profession_counts.csv', index=False)
